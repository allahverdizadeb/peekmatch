...
export const az = {
  updated: 'Son yenilənmə: 20 iyul 2026',
  privacy: {
    ...
    sections: [
      ...
      ['3. Məlumatlardan necə istifadə edirik?', ['Məlumatlarınız yalnız aşağıdakı məqsədlərlə istifadə edilir:', '• CV və vakansiyanı müqayisə etmək;', '• əsas tələbləri və kritik boşluqları müəyyənləşdirmək;', '• uyğunluq göstəricilərini hesablamaq;', '• güclü tərəflər və müraciət tövsiyəsi hazırlamaq;', '• CV Dəyişiklik Planı və müsahibə hazırlığı materialları yaratmaq;', '• ödənişi təsdiqləmək və alınmış paketi aktivləşdirmək;', '• platformanın təhlükəsizliyini qorumaq;', '• texniki xətaları və sui-istifadə hallarını müəyyənləşdirmək;', '• istifadəçi müraciətlərinə cavab vermək.', 'PeekMatch fərdi məlumatlarınızı satmır və onları reklam məqsədilə istifadə etmir.']],
  ...
  terms: {
    ...
    sections: [
      ...
      ['2. Xidmətin təsviri', ['PeekMatch aşağıdakı xidmətləri təqdim edə bilər:', '• CV və vakansiya uyğunluğunun analizi;', '• namizədin uyğunluq göstəricisi;', '• əsas tələblərin müqayisəsi və kritik boşluqlar;', '• güclü tərəflər və müraciət tövsiyəsi;', '• ətraflı uyğunluq hesabatı;', '• vakansiyaya uyğun CV Dəyişiklik Planı;', '• müsahibə hazırlığı materialları;', '• PDF və DOCX sənədləri.', 'Bəzi funksiyalar ödənişsiz, bəzi funksiyalar isə ödənişlidir.']],
