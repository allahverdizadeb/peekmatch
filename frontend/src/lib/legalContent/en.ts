...
export const en: LegalContent = {
  ...
  privacy: {
    ...
    sections: [
      ...
      ['3. How do we use the data?', ['Your data is used only to:', '• compare the CV and the vacancy;', '• identify key requirements and critical gaps;', '• calculate match indicators;', '• prepare strengths and an application recommendation;', '• generate a CV Change Plan and interview preparation materials;', '• confirm payment and activate the purchased package;', '• protect platform security;', '• detect technical errors and abuse;', '• respond to user requests.', 'PeekMatch does not sell your personal data or use it for advertising.']],
  ...
  terms: {
    ...
    sections: [
      ...
      ['2. Service description', ['PeekMatch may provide:', '• CV–vacancy match analysis;', '• a candidate match indicator;', '• key-requirement comparison and critical gaps;', '• strengths and an application recommendation;', '• a detailed compatibility report;', '• a vacancy-specific CV Change Plan;', '• interview preparation materials;', '• PDF and DOCX documents.', 'Some features are free; others are paid.']],
  ...
  deletion: {
    title: 'Data Deletion',
    sections: [
      ['Automatic deletion', ['The following data is automatically deleted within a maximum of 24 hours after the analysis is created:', '• the original CV file and extracted text;', '• the vacancy URL and text;', '• the match analysis, strengths and critical gaps;', '• the CV Change Plan;', '• interview preparation materials;', '• generated PDF and DOCX files.']],
